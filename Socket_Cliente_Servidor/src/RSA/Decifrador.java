...
public class Decifrador {
     ...
     * versão do JDK.
     * @throws NoSuchPaddingException PKCS5Padding não disponível na sua versão
     * do JDK.
     * @throws InvalidKeyException Se a chave passada for inválida.
     * @throws IllegalBlockSizeException Não deve ocorrer.
     * @throws BadPaddingException Se houver um erro de decifração (chave
     * incorreta ou texto cifrado incorreto, por exemplo)
