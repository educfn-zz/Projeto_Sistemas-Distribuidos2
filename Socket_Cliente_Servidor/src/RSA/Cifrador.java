...
public class Cifrador {
     ...
     * @param textoClaro O bloco de dados a ser cifrado.
     ...
     * @throws NoSuchAlgorithmException Algoritmo (AES) não disponível na sua
     * versão do JDK.
     * @throws NoSuchPaddingException Padding (PKCS5Padding) não disponível na
     * sua versão do JDK.
     * @throws InvalidKeyException Se a chave pública for inválida.
     * @throws IllegalBlockSizeException Não deve ocorrer.
     * @throws BadPaddingException Não deve ocorrer.
     * @throws InvalidAlgorithmParameterException Não deve ocorrer.
     */
    public byte[][] cifra(PublicKey pub, byte[] textoClaro) throws 
